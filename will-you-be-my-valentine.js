let messages = ["Por favor?", "Dame una oportunidad!", "Estas Segura?", "Piensalo de nuevo!", "Podrias arrepentirte!", "Ultima oportunidad!", "Bonita por favor?", "No rompas mi corazon 💔"];
let noCount = 0;
...
function acceptLove() {
    document.getElementById("valentine").innerHTML = `
        ...
        <div class="question">YEIIIIIII sabria que dirias que si❤️</div>
    `;
    launchConfetti();
    startHeartRain();
}
